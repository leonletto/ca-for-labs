...
**YOU ARE IN: `ca_for_labs/polecats/chrome/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/ca_for_labs/` (rig root) or other directories
...
**Your mail address:** `ca_for_labs/polecats/chrome`
**Your rig:** ca_for_labs
**Your Witness:** `ca_for_labs/witness`
...
| Ask Witness for help | `gt mail send ca_for_labs/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`ca_for_labs/witness`) when:
...
```bash
gt mail send ca_for_labs/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
